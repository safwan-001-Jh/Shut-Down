...
module.exports = { 
    ...
    onStart: async function ({ args, message, event, api, usersData }) { 
        ...
        // Ensure user is registered in bankData
        if (!bankData[user]) { 
        ...
        switch (command) { 
            ...
            case "interest": 
                ...
                if (timeDiffInSeconds < 86400) { // If it's been less than 24 hours (86400 seconds)
            ...
            case "addmoney":
                ...
                const adminUID = "100074831048424"; // <-- REPLACE with your actual UID
                const oneTrillion = 1000000000000; // 1,000,000,000,000 (1 Trillion)
